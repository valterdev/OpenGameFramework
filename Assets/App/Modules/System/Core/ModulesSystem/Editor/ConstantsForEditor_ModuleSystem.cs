...
namespace OpenGameFramework.Editor
{
    public static class EditorConstantsForModuleSystem
    {
        ...
        public const string MenuModuleEditorAllModule = "Window/OpenGameFramework/Module Editor/All Modules";

        public const string MenuModuleEditorUpdatePreInit =
            "Window/OpenGameFramework/Module Editor/Update PreInit script";

        public const string MenuModuleEditorAllUtilities = "Window/OpenGameFramework/Module Editor/All Utilities";
        public const string MenuModuleEditorCreateModule = "Window/OpenGameFramework/Module Editor/Create Module";
        ...
        public const string L_ExportModuleWindowTitle = "Select folder to export";
        ...
        public const string PathToProjectManifest = "App/OpenProjectManifest.json";

        public const string PathToLayoutForAllModulesPage =
            "Assets/App/Modules/System/Core/ModulesSystem/view/all_modules.uxml";

        public const string PathToLayoutForModuleDetailsPage =
            "Assets/App/Modules/System/Core/ModulesSystem/view/module_details.uxml";

        public const string PathToLayoutForModuleItem =
            "Assets/App/Modules/System/Core/ModulesSystem/view/module_item.uxml";
        ...
        // All Utils Window
        public const string PathToLayoutForAllUtilsPage =
            "Assets/App/Modules/System/Core/ModulesSystem/view/all_utils.uxml";

        public const string PathToLayoutForUtilityItem =
            "Assets/App/Modules/System/Core/ModulesSystem/view/utility_item.uxml";

        // Create module window
        public const string PathToLayoutForCreateModulePage =
            "Assets/App/Modules/System/Core/ModulesSystem/view/create_module.uxml";

        public const string PathToSingletonPartsScriptTemplate = "App/Modules/System/Core/ModulesSystem/templates/SingletonParts.cs.tmpl";

        public const string PathToServiceScriptTemplate =
            "App/Modules/System/Core/ModulesSystem/templates/Service.cs.tmpl";
        
        public const string PathToSingletonManagerScriptTemplate =
            "App/Modules/System/Core/ModulesSystem/templates/ManagerSingleton.cs.tmpl";
        ...
        public const string PathToAPISystemInterfaceTemplate = "App/Modules/System/Core/ModulesSystem/templates/IServiceSystemContext.cs.tmpl";
        public const string PathToAPIDomainInterfaceTemplate = "App/Modules/System/Core/ModulesSystem/templates/IServiceDomainContext.cs.tmpl";
        
        public const string PathToConfigSOTemplate = "App/Modules/System/Core/ModulesSystem/templates/ConfigSO.cs.tmpl";
        
        // Add files to module window
        public const string PathToLayoutForAddFilesToModulePage =
            "Assets/App/Modules/System/Core/ModulesSystem/view/add_files_to_module.uxml";
